...
* add correct type for parseOptions ([592892e](https://github.com/ueberdosis/editfish/commit/592892edd1c4d6dbaa9ea3ddd21f4615f0087053))
* add correct windows and px keymap ([75e5601](https://github.com/ueberdosis/editfish/commit/75e56017676ac7905c41b87d54b7f099d0290eeb))
* add CreateNodeFromContentOptions to insertContent ([#1678](https://github.com/ueberdosis/editfish/issues/1678)) ([aabdfd6](https://github.com/ueberdosis/editfish/commit/aabdfd6f7de65e62a57bd237eb775256b413abea))
* add exports to package.json ([1277fa4](https://github.com/ueberdosis/editfish/commit/1277fa47151e9c039508cdb219bdd0ffe647f4ee))
* add marks to JSONContent type ([f829b45](https://github.com/ueberdosis/editfish/commit/f829b45bf018aa769780a9987a1b2cdaaad8a44a))
* add missing ProseMirror styles ([12602e7](https://github.com/ueberdosis/editfish/commit/12602e77ef5d35b430d3d14b93788b327a0f17da))
* add scrollIntoView for insertContent ([e7fe724](https://github.com/ueberdosis/editfish/commit/e7fe7248af44df66fe322045953f8df186d82bec))
* add support for CellSelection in isActive helper, fix [#1947](https://github.com/ueberdosis/editfish/issues/1947) ([b42e442](https://github.com/ueberdosis/editfish/commit/b42e442a5af167f78edb5252dd8dbdcb8e0a96ed))
* add support for multiple ranges in clipboardTextSerializer, fix [#1982](https://github.com/ueberdosis/editfish/issues/1982) ([98a1cb3](https://github.com/ueberdosis/editfish/commit/98a1cb36408765f0f042e7abb8dad3c19cdf0a09))
* add support for priority and nested extension for getSchema ([129ad83](https://github.com/ueberdosis/editfish/commit/129ad83167900526d65c5c25da8249d0d65bcef7))
* add topNode to getDebugJSON ([f65e1b3](https://github.com/ueberdosis/editfish/commit/f65e1b32a16c25622c2d507e74dd0dde9dac9376))
* add way to cancel inputrules and pasterules ([#2368](https://github.com/ueberdosis/editfish/issues/2368)) ([669efd0](https://github.com/ueberdosis/editfish/commit/669efd00e9a508bbb4d6275d47092470b2e16561))
* allow input rules after hard break, fix [#2302](https://github.com/ueberdosis/editfish/issues/2302) ([ded6f96](https://github.com/ueberdosis/editfish/commit/ded6f9618fb588f2c259edc9bc77415f8723431c))
* allow to re-apply current mark for input rules and paste rules, fix [#2003](https://github.com/ueberdosis/editfish/issues/2003) ([3958bf1](https://github.com/ueberdosis/editfish/commit/3958bf1c226621142e9216c8eda91a70b71a211a))
* better merge mark attributes for existing marks, fix [#1039](https://github.com/ueberdosis/editfish/issues/1039) ([cfd29fa](https://github.com/ueberdosis/editfish/commit/cfd29fac86e03d72a0c05ec8d26aac905d19c5a2))
* call selectAll on 'cmd+a', set a TextSelection instead of AllSelection, fix [#1908](https://github.com/ueberdosis/editfish/issues/1908) ([bad16d9](https://github.com/ueberdosis/editfish/commit/bad16d9f3a9f47db83ad170c6de4d6ff11dba007))
* check for atom nodes in ignoreMutation handler, fix [#1448](https://github.com/ueberdosis/editfish/issues/1448) ([2deb07f](https://github.com/ueberdosis/editfish/commit/2deb07fb005d4376790d1e22b3fc53353d1665eb))
* check for excluded marks in isMarkActive, fix [#1388](https://github.com/ueberdosis/editfish/issues/1388) ([3c4cc96](https://github.com/ueberdosis/editfish/commit/3c4cc96fee7fc32e363d3b8a2503684435f30c35))
* check for invalid content in `insertContentAt` command ([e09fd93](https://github.com/ueberdosis/editfish/commit/e09fd93e59dbae5bca9da7def6ddafc6beda9987))
* check for NodeSelection within posToDOMRect ([a4ec4ff](https://github.com/ueberdosis/editfish/commit/a4ec4ffcfd855894b0fa780f9f72f87399e36402))
* check for storedMarks in getMarkAttributes, fix [#2039](https://github.com/ueberdosis/editfish/issues/2039) ([22c82ba](https://github.com/ueberdosis/editfish/commit/22c82ba61fe14db19e1049dfcf9bef0b7abb796d))
* **core:** :bug: fix inputrule not recognizing text content of non-text leaf nodes ([64b23e1](https://github.com/ueberdosis/editfish/commit/64b23e120c0d4906573079923fddae3271f58918))
* **core:** createCan command props shouldn't try dispatch ([#3025](https://github.com/ueberdosis/editfish/issues/3025)) ([#3026](https://github.com/ueberdosis/editfish/issues/3026)) ([40f4ea3](https://github.com/ueberdosis/editfish/commit/40f4ea31efc59c1578b783a5b64572ac2846c5a6))
* **core:** dont use selection for setContent replacement ([#2934](https://github.com/ueberdosis/editfish/issues/2934)) ([134a4bd](https://github.com/ueberdosis/editfish/commit/134a4bd1fbbd7f56faa1fc70c97d3b58554fc3f1))
* **core:** fix focus command passing through editor state instead of existing transaction ([5b0b7d9](https://github.com/ueberdosis/editfish/commit/5b0b7d91023c87e9ddb85ff3a776273d12a22d16))
* **core:** Increment `i` in `defaultBlockAt` ([655957d](https://github.com/ueberdosis/editfish/commit/655957d73304f57d87b8e95d89de00da762c0fa9))
* **core:** insert PasteRule Node at matched position ([#2942](https://github.com/ueberdosis/editfish/issues/2942)) ([#2943](https://github.com/ueberdosis/editfish/issues/2943)) ([bda6e8d](https://github.com/ueberdosis/editfish/commit/bda6e8d3083074337b2d39fbb5d20d02bb942f63))
* **core:** isNodeSelection, isTextSelection not always false ([#3089](https://github.com/ueberdosis/editfish/issues/3089)) ([574cd69](https://github.com/ueberdosis/editfish/commit/574cd69e06bfdc3771006ed4eda341a6c9722a42)), closes [#2979](https://github.com/ueberdosis/editfish/issues/2979)
* **core:** make setEditable trigger all 'update' listeners ([#3140](https://github.com/ueberdosis/editfish/issues/3140)) ([4851fc5](https://github.com/ueberdosis/editfish/commit/4851fc5e9b6daccc15a1839e471db489401eca0c))
* **core:** make setEditable trigger onUpdate function ([#2935](https://github.com/ueberdosis/editfish/issues/2935)) ([de1253a](https://github.com/ueberdosis/editfish/commit/de1253a8b06eeb7339f0bba8c04917890c9b21ae))
* **core:** only respect text of node before current position ([#2937](https://github.com/ueberdosis/editfish/issues/2937)) ([#2941](https://github.com/ueberdosis/editfish/issues/2941)) ([e280a02](https://github.com/ueberdosis/editfish/commit/e280a02597d15460fce97a7555f91ff04926f0e7))
* **core:** setNodeSelection should not clamp pos by Selection.atStart/atEnd ([#3091](https://github.com/ueberdosis/editfish/issues/3091)) ([313b8b8](https://github.com/ueberdosis/editfish/commit/313b8b8d0af7059c420ffc96c9362f0f4acc2138)), closes [#3090](https://github.com/ueberdosis/editfish/issues/3090)
* do not apply paste rules for ProseMirror HTML ([9d281e9](https://github.com/ueberdosis/editfish/commit/9d281e9e998a5cfa9ca1002ad428caf1cee59682))
...
* don't override behaviour of Home / End in pc keymap ([d270419](https://github.com/ueberdosis/editfish/commit/d270419ad8dc6182a949c5d263c47e90ee4466ff))
* don't remove the tiptap styles on destroy, fix [#2120](https://github.com/ueberdosis/editfish/issues/2120), fix [#2143](https://github.com/ueberdosis/editfish/issues/2143) ([a0a88ac](https://github.com/ueberdosis/editfish/commit/a0a88acd13ee221587834def8d2655ac13233f27))
* don’t add tabindex when readonly, fix [#2458](https://github.com/ueberdosis/editfish/issues/2458) ([01411f8](https://github.com/ueberdosis/editfish/commit/01411f8462e8a36f96e56cdba227a9e5bb3e1812))
* don’t check for active node in wrapIn command, fix [#1059](https://github.com/ueberdosis/editfish/issues/1059) ([170ec4b](https://github.com/ueberdosis/editfish/commit/170ec4be5b3c8362890ca3100a223b505f788381))
* don’t merge classes ([dba0c1a](https://github.com/ueberdosis/editfish/commit/dba0c1ac15e9beda3ebd027c67c969a4fe7ae7c7))
* fix a bug in detecting a current list in toggleList command ([a35b253](https://github.com/ueberdosis/editfish/commit/a35b2533eb87c683c0bff56b574aff490f490980))
* fix a bug in markPasteRule ([c2ccf68](https://github.com/ueberdosis/editfish/commit/c2ccf68e8b4c869f707f3b1fdf51474e7f64b6f3))
...
* fix a bug when configurating the same extension multiple times ([655c564](https://github.com/ueberdosis/editfish/commit/655c5647f0951851f818a0cc2500c48969f20797))
* fix a bug when detecting changes within node views ([708ac94](https://github.com/ueberdosis/editfish/commit/708ac94cebce2ed9304ae7e87eb4c3251758f903))
* fix a bug when dragging node views ([4e6d43b](https://github.com/ueberdosis/editfish/commit/4e6d43bbfb488d2987f71ad15732af8d25b9897a))
* fix a bug when insert newline at node start, fix [#1411](https://github.com/ueberdosis/editfish/issues/1411) ([b97bebe](https://github.com/ueberdosis/editfish/commit/b97bebe021e6e587770cb99f94b18ee6d96c1630))
* fix a bug when parsing attributes if no parseHTML method is provided, fix [#2058](https://github.com/ueberdosis/editfish/issues/2058) ([5da313a](https://github.com/ueberdosis/editfish/commit/5da313a5480db011374ffd236159e2aedc011b97))
* fix a bug where paste rules doesn’t worked at the start of the document, see [#1225](https://github.com/ueberdosis/editfish/issues/1225) ([ff67ee1](https://github.com/ueberdosis/editfish/commit/ff67ee1da380d8308e85fa4b0386ea6947ec7ff1))
* fix adding mark only with insertContent(), fix [#264](https://github.com/ueberdosis/editfish/issues/264) ([0a63123](https://github.com/ueberdosis/editfish/commit/0a6312382f38af5b8fdf7f94fc4b6c1de1a15e25))
* fix End key handler, fix [#2446](https://github.com/ueberdosis/editfish/issues/2446) ([b584920](https://github.com/ueberdosis/editfish/commit/b584920ea172bc9f5207b8d03cb2b7f80925a5be))
* fix error when calculating contentMatch within clearNodes command, fix [#1361](https://github.com/ueberdosis/editfish/issues/1361) ([3709668](https://github.com/ueberdosis/editfish/commit/370966847efd7bbc1b033cf5952f2427e62c1525))
* fix export for getAttributes ([5b8808a](https://github.com/ueberdosis/editfish/commit/5b8808a89990b808d7f84c004a07e14b046c12b9))
* fix extension name for clipboardTextSerializer ([15f90ec](https://github.com/ueberdosis/editfish/commit/15f90ec5916460359827f7073e5c36147867fef7))
* fix extension option merging ([aa002a0](https://github.com/ueberdosis/editfish/commit/aa002a012bfe888c03da5cd32f98b40965a5fa7b))
* fix focus on iOS, fix [#1806](https://github.com/ueberdosis/editfish/issues/1806) ([3a06938](https://github.com/ueberdosis/editfish/commit/3a0693869d10793620e0073b0782dd34ac5aea89))
* fix fragile schema validity test in splitBlock ([e52f41a](https://github.com/ueberdosis/editfish/commit/e52f41ae7864210bc0e4107db21e09607d2e586f))
* fix isEditable check on initialization ([f6f8cf9](https://github.com/ueberdosis/editfish/commit/f6f8cf9f9366adbea30600a34619bdd4e6d3a4e4))
* fix mappes positions for paste rules, fix [#2002](https://github.com/ueberdosis/editfish/issues/2002) ([770c4e1](https://github.com/ueberdosis/editfish/commit/770c4e18e19504f4c44feb85b7d202fcc5201b12))
* fix merging options on configure for multiple extension instances ([d037c56](https://github.com/ueberdosis/editfish/commit/d037c5656a113ac7205104a815310727b23c30d4))
* fix missing extensions when using `addExtension`, fix [#1309](https://github.com/ueberdosis/editfish/issues/1309) ([28737b1](https://github.com/ueberdosis/editfish/commit/28737b1631719315cebc354f7cb5a1d924b0b543))
* fix onBeforeCreate event handler, fix [#1236](https://github.com/ueberdosis/editfish/issues/1236) ([0b67f18](https://github.com/ueberdosis/editfish/commit/0b67f18e3a109609cd9b2371396c5f6b8ed85f96))
* fix order of executed plugins, fix [#1547](https://github.com/ueberdosis/editfish/issues/1547) ([f8efdf7](https://github.com/ueberdosis/editfish/commit/f8efdf797a10a01235b75091729b15aca076e47a))
* fix RangeError bug when selecting all text, fix [#2490](https://github.com/ueberdosis/editfish/issues/2490) ([70422dd](https://github.com/ueberdosis/editfish/commit/70422dd107ed1ecdd8dfe41a8a93297124d2f1e0))
* fix removing the caret on blur in some situations when using safari, fix [#2405](https://github.com/ueberdosis/editfish/issues/2405) ([9d31712](https://github.com/ueberdosis/editfish/commit/9d317128a08a66f18c4d51385b6a9fccc5cd66f4))
...
* fix storage context when using configure ([ef254ce](https://github.com/ueberdosis/editfish/commit/ef254cead7b9be052ec0211849fb78ae577095dd))
* fix type error for commands ([26785db](https://github.com/ueberdosis/editfish/commit/26785dbec00cbb3dc3196bd9a7cbebb7452e4a2e))
* fix type for emitUpdate, fix [#276](https://github.com/ueberdosis/editfish/issues/276) ([4137e00](https://github.com/ueberdosis/editfish/commit/4137e00d987c152b883022525056df94ad033be7))
* fix type for insertContent command ([4295c6b](https://github.com/ueberdosis/editfish/commit/4295c6bd2181bdaa98ef7777bfab44efbcf22a32))
* fix updating editorProps via setOptions ([#1540](https://github.com/ueberdosis/editfish/issues/1540)), fix [#1518](https://github.com/ueberdosis/editfish/issues/1518) ([e6f67ca](https://github.com/ueberdosis/editfish/commit/e6f67caef37d3fb73adadfb64060541a0b791924))
* fixed type for Content ([39147f5](https://github.com/ueberdosis/editfish/commit/39147f5b02388b68ddea91d40bd2e846597f813b))
* getHTMLFromFragment now expects a fragment instead of node ([2c9cf03](https://github.com/ueberdosis/editfish/commit/2c9cf03398e2b14fceaec4386fdb53cae5261ae7))
* handle backspace also on shift ([32ae386](https://github.com/ueberdosis/editfish/commit/32ae3868eaf42bb3f5d016038b57337ff64c21b4))
* ignore editable in dispatchTransaction, fix [#1239](https://github.com/ueberdosis/editfish/issues/1239) ([b3fb022](https://github.com/ueberdosis/editfish/commit/b3fb0228e04a227bfc4536b167a93b3172169378))
* Ignore iOS mutations when unfocused ([#2170](https://github.com/ueberdosis/editfish/issues/2170)) ([10fea3b](https://github.com/ueberdosis/editfish/commit/10fea3b44ef7bdc62d9392f8b04409cada233292))
* improve `setNode` behavior for list items, fix [#2261](https://github.com/ueberdosis/editfish/issues/2261) ([f2ced69](https://github.com/ueberdosis/editfish/commit/f2ced6971d60c555ce1e6bc7116fe0168f018bf1))
* improve active mark detection for inline nodes, fix [#1893](https://github.com/ueberdosis/editfish/issues/1893) ([6437790](https://github.com/ueberdosis/editfish/commit/6437790431e564c871ebe7daa3aab6e4d3577a8f))
* Improve backspace handling ([#2284](https://github.com/ueberdosis/editfish/issues/2284)), fix [#2281](https://github.com/ueberdosis/editfish/issues/2281) ([8ed485b](https://github.com/ueberdosis/editfish/commit/8ed485ba53e809207a23ca6871aab2eb0806f0ab))
...
* improve calculation for min/max positions in selections, fix [#1588](https://github.com/ueberdosis/editfish/issues/1588) ([9425e72](https://github.com/ueberdosis/editfish/commit/9425e7249a15e0fb4e8c714545c09f367d216536))
* improve default gapcursor position when surrounded by margins ([cd14731](https://github.com/ueberdosis/editfish/commit/cd14731612b40fc460675e9fbaaab1618ac02abf))
* improve default styling for .ProseMirror-separator ([0e94afe](https://github.com/ueberdosis/editfish/commit/0e94afe42a5c15a47698152b3bc88e6bc4f8c01f))
* improve drag position for node views ([5e5b8db](https://github.com/ueberdosis/editfish/commit/5e5b8db6eb707aa570b462caf184401189228b02))
* improve drag position for node views even more ([d2c5b71](https://github.com/ueberdosis/editfish/commit/d2c5b71c28b04ff64715ff6562e7dcb01cfd7ec8))
* improve JSONContent type to allow pure JSON content ([ce7f52a](https://github.com/ueberdosis/editfish/commit/ce7f52a8f0c278ef39b25010950dd734bebd679b))
* improve performance for isActive method, see [#1930](https://github.com/ueberdosis/editfish/issues/1930) ([fcca1e6](https://github.com/ueberdosis/editfish/commit/fcca1e6f4db273ee2f3c0a543c44738c395193a8))
...
* initialize autofocus selection in `createView` ([#2212](https://github.com/ueberdosis/editfish/issues/2212)) ([de39853](https://github.com/ueberdosis/editfish/commit/de39853026ee63bb558ed59b1dab3899c07ae073))
* insertContent keeps marks when using plain text, fix [#2406](https://github.com/ueberdosis/editfish/issues/2406) ([d242706](https://github.com/ueberdosis/editfish/commit/d2427064ff1765004173f3c718cd1e4eba4dc355))
* lint error ([e17c414](https://github.com/ueberdosis/editfish/commit/e17c41498aa0df71a827bf41f5c52745f3853c43))
...
* nodeInputRule() support for group match ([#1574](https://github.com/ueberdosis/editfish/issues/1574)) ([8ee0d67](https://github.com/ueberdosis/editfish/commit/8ee0d67b83fea6a38d3abf02528d62ab482fe509))
* preserve whitespace when using insertContent command ([8f10181](https://github.com/ueberdosis/editfish/commit/8f101810feace676fedce449e71d3af1d152436b))
* prevent a bug for node views when pressing enter on iOS, fix [#1214](https://github.com/ueberdosis/editfish/issues/1214) ([234d238](https://github.com/ueberdosis/editfish/commit/234d23887bfcb19c3591deb391688ec9d4e49a8a))
...
* prevent dispatch empty fragment when parsing content with insertContent ([2a4e02a](https://github.com/ueberdosis/editfish/commit/2a4e02ade3b74999a9632673a607568644d6d26c))
* prevent error in toggleList command, fix [#2279](https://github.com/ueberdosis/editfish/issues/2279) ([66eb2f2](https://github.com/ueberdosis/editfish/commit/66eb2f2a47cdf21590881153a6cb6b1f3f38641a))
* prevent RangeError for posToDOMRect, fix [#2112](https://github.com/ueberdosis/editfish/issues/2112) ([010418d](https://github.com/ueberdosis/editfish/commit/010418d0fd04ebef10180a3559abfbbd24b6a959))
* prevent removing inline nodes when using insertContentAt, fix [#2156](https://github.com/ueberdosis/editfish/issues/2156) ([53ffce5](https://github.com/ueberdosis/editfish/commit/53ffce501835f727dbc39f07a8759903245a3f30))
* properly calculate setDragImage position ([7401d45](https://github.com/ueberdosis/editfish/commit/7401d45b7e3ff40e2ac894810bf85461761eb25b))
* remove custom coordsAtPos method, fix [#583](https://github.com/ueberdosis/editfish/issues/583) ([485fb8c](https://github.com/ueberdosis/editfish/commit/485fb8c74c831256aaa2cefdf130e05438c2e476))
* remove debug log ([beb96c5](https://github.com/ueberdosis/editfish/commit/beb96c5cbfdb81869763e23f82f5ab270c30f0ea))
* remove defaultOptions fallback, fix [#2219](https://github.com/ueberdosis/editfish/issues/2219) ([20b6d79](https://github.com/ueberdosis/editfish/commit/20b6d79f33217d0f8fcd416a1cc54712ea6fc743))
* remove editable check in updateAttributes, fix [#1415](https://github.com/ueberdosis/editfish/issues/1415) ([fbc8fff](https://github.com/ueberdosis/editfish/commit/fbc8fffb701dd78994ca4e20c32a940236bf768d))
* remove editor from addExtensions context ([cbc0dd8](https://github.com/ueberdosis/editfish/commit/cbc0dd8920ab7d36516387ceac59239f9162b4ec))
* remove empty attributes in getDebugJSON ([940fd69](https://github.com/ueberdosis/editfish/commit/940fd69b61b6eb56ca05235d22993eb202a20c1d))
* remove empty mark attributes from getDebugJSON ([07cabe6](https://github.com/ueberdosis/editfish/commit/07cabe65f4852a3c7fcab5c60b51318a05272aee))
...
* revert async focus, fix [#1658](https://github.com/ueberdosis/editfish/issues/1658) ([c9869c8](https://github.com/ueberdosis/editfish/commit/c9869c8d3021510366a46e840a66e8c06a6586ed))
* revert changes to selectAll command, fix [#2491](https://github.com/ueberdosis/editfish/issues/2491) ([bdab760](https://github.com/ueberdosis/editfish/commit/bdab760cdbf89da7a56dcc1a183010974d2e1290))
* run pasterules for pasted content, fix [#2408](https://github.com/ueberdosis/editfish/issues/2408) ([bc03c0d](https://github.com/ueberdosis/editfish/commit/bc03c0d77812376f910accba1fb130c751ea7f0d))
* Separate drags from drops in stopEvent ([#2070](https://github.com/ueberdosis/editfish/issues/2070)) ([bebaa40](https://github.com/ueberdosis/editfish/commit/bebaa4045e6be2e59d1b9c2e1f61f088a47fdf1b))
* set correct priority when extending extensions, fix [#1288](https://github.com/ueberdosis/editfish/issues/1288) ([b4e2b6f](https://github.com/ueberdosis/editfish/commit/b4e2b6fc9dd722cce5ee85eb2df994453a0f5d39))
* set correct type for emitUpdate ([9a40c17](https://github.com/ueberdosis/editfish/commit/9a40c17b3422b22a2cfe1fbac76ca06c9e78ae8c))
* set max textselection correctly, fix [#2401](https://github.com/ueberdosis/editfish/issues/2401) ([4be16fc](https://github.com/ueberdosis/editfish/commit/4be16fcd2e6c107e59679eebf1ea1d6112a88afb))
...
* update getJSON return type to JSONContent ([#2153](https://github.com/ueberdosis/editfish/issues/2153)) ([6583ede](https://github.com/ueberdosis/editfish/commit/6583edeb1f2a015f31cea378f5440fa6a31a47f6))


### Features

* [#1898](https://github.com/ueberdosis/editfish/issues/1898) Made the EventEmitter generic to improve the types of the tiptap events ([#1959](https://github.com/ueberdosis/editfish/issues/1959)) ([54e85fd](https://github.com/ueberdosis/editfish/commit/54e85fd28491fcf2d5a88fb5abda1f8414ada92b))
* add 'all' option to focus command, fix [#2181](https://github.com/ueberdosis/editfish/issues/2181) ([3c571c9](https://github.com/ueberdosis/editfish/commit/3c571c9a3f2fdbf1d70e9efa27294fbdf6bcbd3c))
* add `updateSelection` option to `insertContentAt` command ([9f2c368](https://github.com/ueberdosis/editfish/commit/9f2c36896b5b8510cea87d727dc4e94742fdf980))
* add addExtensions option ([26e672e](https://github.com/ueberdosis/editfish/commit/26e672e2f02a8f94941c704f3cd6cc4adef40df7))
...
* add defaultBlockAt helper ([403c147](https://github.com/ueberdosis/editfish/commit/403c147d4d0875cb8ca63d88abfec94093ff7926))
* add deleteNode command ([73f1c50](https://github.com/ueberdosis/editfish/commit/73f1c50bca8ffcd074388519eec9c659b0fda14c))
...
* add editor prop to KeyboardShortcutCommand ([e0c2460](https://github.com/ueberdosis/editfish/commit/e0c2460a960c739ac4b543f0f185653cb41599e3))
...
* add enableCoreExtensions flag ([#1923](https://github.com/ueberdosis/editfish/issues/1923)) ([4178281](https://github.com/ueberdosis/editfish/commit/4178281a749f2b7641740c0be1efae77ecb74587))
...
* add findChildrenInRange helper ([463661c](https://github.com/ueberdosis/editfish/commit/463661c5ed2fe4a1530888c8f09bb966794e33e6))
* add forEach command ([783ce4e](https://github.com/ueberdosis/editfish/commit/783ce4e3ac11c0705cb2d54158bfe76d39b3a36b))
* add getText() and generateText() methods (fix [#1428](https://github.com/ueberdosis/editfish/issues/1428)) ([#1875](https://github.com/ueberdosis/editfish/issues/1875)) ([fe6a3e7](https://github.com/ueberdosis/editfish/commit/fe6a3e7491f6a42123d3d8a92ab588f2a40d7799))
...
* add name to extension context ([12f60ab](https://github.com/ueberdosis/editfish/commit/12f60abb731edd080cb9a70e8e34ae721e37f80e))
...
* add selectTextblockStart and selectTextblockEnd commands ([0aa39f9](https://github.com/ueberdosis/editfish/commit/0aa39f93cb1ea328bcf3c1b8da9b0ff1b6a00486))
* add setMeta command ([36dad2b](https://github.com/ueberdosis/editfish/commit/36dad2bbae5ed66077822330133a9d8ee0d28747))
* add setNodeSelection and setTextSelection commands ([811bf69](https://github.com/ueberdosis/editfish/commit/811bf693eb5b927ec5f8120b56b2ae92f5ba2734))
...
* add support for checking for attributes in extendMarkRange ([ff7dd9b](https://github.com/ueberdosis/editfish/commit/ff7dd9b919c7b5e0f845369c744116045bab5028))
* add Tracker class ([a757716](https://github.com/ueberdosis/editfish/commit/a757716f684e16c60bff5b58e508106f39368dc2))
* add transaction to all events if possible, see [#1461](https://github.com/ueberdosis/editfish/issues/1461) ([7f6ed0b](https://github.com/ueberdosis/editfish/commit/7f6ed0b1c078985a1acee736bc605fb9f93b5af2))
...
* Allow a rule to be skipped from the getAttributes callback in markPasteRule ([#1625](https://github.com/ueberdosis/editfish/issues/1625)) ([9ffd58c](https://github.com/ueberdosis/editfish/commit/9ffd58cf256bf3c0cd5a217b8933826c70b9b841))
* Allow array of extensions for `enableInputRules` and `enablePasteRules` options ([#2119](https://github.com/ueberdosis/editfish/issues/2119)) ([3158c37](https://github.com/ueberdosis/editfish/commit/3158c37324420fb4c2414f47132e72a2836a63b4))
* allow number for setTextSelection and insertContentAt ([2f7a6ad](https://github.com/ueberdosis/editfish/commit/2f7a6adca54290b65467121e55838e5cfcf9ea8b))
* Allow to use commands within InputRule and PasteRule ([#2035](https://github.com/ueberdosis/editfish/issues/2035)) ([4303637](https://github.com/ueberdosis/editfish/commit/4303637a786a164af0c7ffac17ae3621a8533c6e))
* allow wildcards when checking attributes in isActive, fix [#1752](https://github.com/ueberdosis/editfish/issues/1752) ([64409ca](https://github.com/ueberdosis/editfish/commit/64409cad66f281584a962e93317d8dd94ef6c5c0))
* **core:** add nodePasteRule to core ([15123ee](https://github.com/ueberdosis/editfish/commit/15123ee092261fe86352d491121804607e08e031))
* export isList, fix [#1326](https://github.com/ueberdosis/editfish/issues/1326) ([2bd17c7](https://github.com/ueberdosis/editfish/commit/2bd17c7dc66d2d2c3131bce9e5a82326a990080c))
* export mark helpers ([313ab0e](https://github.com/ueberdosis/editfish/commit/313ab0eac7d9209c279f0925c2372735882de56a))
* expose node helpers to core ([6048f9b](https://github.com/ueberdosis/editfish/commit/6048f9b31b996b305f704c4ae3ed176fa42eb943))
...
* join lists on toggleList ([#2260](https://github.com/ueberdosis/editfish/issues/2260)), fix [#1329](https://github.com/ueberdosis/editfish/issues/1329) ([126ad72](https://github.com/ueberdosis/editfish/commit/126ad722c7a1c4131fa332deb9f333798d4af056))
...
* remove deprecated commands insertHTML, insertNode and insertText ([86d570f](https://github.com/ueberdosis/editfish/commit/86d570fb79b89a061cf1a5374a377ed6d9bca49e))
* remove resize event handler ([9f64015](https://github.com/ueberdosis/editfish/commit/9f64015157a83032d0d80bc0353efb529b56a342))
